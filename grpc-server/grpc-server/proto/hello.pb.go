...
func (x *HelloRequest) GetSizeKb() int32 {
	if x != nil {
		return x.SizeKb
	}
	return 0
...
type HelloResponse struct {
	...
	PayloadSizeKb int32                  `protobuf:"varint,3,opt,name=payload_size_kb,json=payloadSizeKb,proto3" json:"payload_size_kb,omitempty"`
...
func (x *HelloResponse) GetPayloadSizeKb() int32 {
	if x != nil {
...
const file_proto_hello_proto_rawDesc = "" +
	...
	"\asize_kb\x18\x01 \x01(\x05R\x06sizeKb\"\x89\x01\n" +
